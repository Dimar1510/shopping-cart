        ...
        <footer>
            ...
            <div className="footer_bottom">
                <div className="developed">
                    <a href="https://github.com/Dimar1510" className="gh-link" rel="noopener noreferrer" target="blank">
                        <GitHub/>
                        Developed by Dimar
                    </a>
                    <a href="https://fake-coffee-api.vercel.app/" className="gh-link" rel="noopener noreferrer" target="blank">
                        <img src={bean} alt="bean" className="gh-icon" />
                        FAKE COFFEE API
                    </a>
                </div>
                <small className="gh-copyright">
